...
export default function contactReducer(
 ...
 {type, payload }) {
switch (type) {
 case ACTION_TYPES.ADD_NEW_CONTACT: return {...state,contactForEdit:createEmptyContact() };
...
case ACTION_TYPES.SELECT_CONTACT: return {...state,contactForEdit:payload};
case ACTION_TYPES.GET_CONTACTS: return {...state,contacts:payload};
